...
**Committing:** Commit the staged changes with a meaningful, concise commit message that describes the changes made. If changes are big and alter core architectural concepts or APIs, ask user if they want to update the CHANGELOG file.
