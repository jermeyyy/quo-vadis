        ...
        return FileSpec.builder(GENERATED_PACKAGE, REGISTRY_NAME)
            ...
            .apply {
                screens.forEach { screenInfo ->
                    addImport(
                        packageName = screenInfo.destinationClass.parentDeclaration!!.packageName.asString(),
                        names = listOf(screenInfo.destinationClass.parentDeclaration!!.simpleName.asString())
                    )
                    addImport(
