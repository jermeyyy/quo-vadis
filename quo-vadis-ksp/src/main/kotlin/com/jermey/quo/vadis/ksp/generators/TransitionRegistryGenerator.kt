...
public class TransitionRegistryGenerator(
    ...
    public fun generate(
        ...
        val fileSpec = buildFileSpec(transitions, addDeprecations)
    ...
    private fun buildFileSpec(transitions: List<TransitionInfo>, addDeprecations: Boolean): FileSpec {
        return FileSpec.builder(GENERATED_PACKAGE, REGISTRY_NAME)
            ...
            .addType(buildRegistryObject(transitions, addDeprecations))
            .build()
    }

    private fun buildRegistryObject(transitions: List<TransitionInfo>, addDeprecations: Boolean): TypeSpec {
