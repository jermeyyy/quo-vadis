 ...
 *
 * Unlike [DeepLinkHandler] which is configured at runtime through manual registration,
 * implementations of this interface are code-generated by the KSP processor from
 * `@Destination` annotations that include route patterns.
 *
 * ## Usage
 *
 ...
 *
 * @see DeepLinkHandler for runtime deep link registration
 * @see DeepLinkResult for possible handling outcomes
 */
public interface GeneratedDeepLinkHandler {
    /**
