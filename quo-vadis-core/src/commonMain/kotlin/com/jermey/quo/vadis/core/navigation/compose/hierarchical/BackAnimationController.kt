...
public class BackAnimationController {
     ...
     */
    public var progress: Float by mutableStateOf(0f)
        private set
     ...
     */
    public var currentEvent: BackNavigationEvent? by mutableStateOf(null)
        private set
     ...
     */
    public fun startAnimation(event: BackNavigationEvent) {
        isAnimating = true
     ...
     */
    public fun updateProgress(event: BackNavigationEvent) {
        progress = event.progress
        currentEvent = event
    }
 ...
 */
public val LocalBackAnimationController = compositionLocalOf<BackAnimationController?> { null }
 ...
 */
@Composable
public fun rememberBackAnimationController(): BackAnimationController {
