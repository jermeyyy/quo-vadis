...
import com.jermey.quo.vadis.core.navigation.dsl.BuiltPanesConfig
import com.jermey.quo.vadis.core.navigation.dsl.BuiltTabsConfig
import com.jermey.quo.vadis.core.navigation.dsl.ContainerBuilder
import com.jermey.quo.vadis.core.navigation.dsl.DslContainerRegistry
...
internal class DslNavigationConfig(
    ...
    private fun buildPaneConfigurations(
        ...
        paneNodeKey: String
    ): Map<com.jermey.quo.vadis.core.navigation.core.PaneRole, PaneConfiguration> {
