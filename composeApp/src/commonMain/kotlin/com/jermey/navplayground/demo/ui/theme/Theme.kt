 ...
 * On Android: Updates status bar and navigation bar icon colors.
 * On iOS: No-op (iOS handles this automatically).
 */
@Composable
expect fun ConfigureSystemUI(useDarkTheme: Boolean)


/**
 * Light theme color scheme for the demo app.
 */
...
/**
 * Dark theme color scheme for the demo app.
 */
@Suppress("MagicNumber")
...
fun NavPlaygroundTheme(
    ...
    ConfigureSystemUI(useDarkTheme = useDarkTheme)
