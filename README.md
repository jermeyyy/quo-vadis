...
plugins {
    ...
    id("io.github.jermeyyy.quo-vadis") version "0.5.1"
}

kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation("io.github.jermeyyy:quo-vadis-core:0.5.1")
            implementation("io.github.jermeyyy:quo-vadis-annotations:0.5.1")
        }
    }
}
...
dependencies {
    ...
    add("kspCommonMainMetadata", "io.github.jermeyyy:quo-vadis-ksp:0.5.1")
}
...
```kotlin
implementation("io.github.jermeyyy:quo-vadis-core-flow-mvi:0.5.1")
```
