...
const hybridExample = `// Annotation-generated config
    ...
    <article className={styles.features}>
      ...
      <section>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>Most projects</td>
              <td>Declarative, compile-time safety, generated by KSP or the experimental compiler plugin</td>
            </tr>
            <tr>
        ...
        <div className={styles.note}>
          <p>
            The DSL is backend-independent and manual. The annotation-based approach uses the same frontend annotations,
            with KSP as the stable backend and the compiler plugin as the experimental backend.
          </p>
        </div>
        ...
        <ul>
          ...
          <li><strong>Multi-module composition</strong> where modules provide their own config and the app combines them explicitly</li>
      ...
      <section>
        ...
        <div className={styles.note}>
          <p>
            This explicit <code>+</code> composition is also the backend-neutral default for annotation-generated
            configs in multi-module apps. Treat compiler-only auto-discovery as an optional enhancement, not the base contract.
          </p>
        </div>
      </section>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><StatusFull>KSP or compiler plugin</StatusFull></td>
            </tr>
            <tr>
              <td>Type safety</td>
            ...
            <tr>
              ...
              <td><StatusFull>KSP manual / compiler plugin auto</StatusFull></td>
            </tr>
            <tr>
      ...
      <section>
        ...
        <ul>
          <li><Link to="/features/annotation-api">Annotation-Based API</Link> – Declarative approach with backend-neutral annotations</li>
          <li><Link to="/features/compiler-plugin">Compiler Plugin (Experimental)</Link> – Compare the experimental backend with KSP</li>
